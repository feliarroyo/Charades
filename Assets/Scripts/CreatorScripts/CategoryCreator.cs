...
public class CategoryCreator : MonoBehaviour
{
    ...
    private const string 
        ...
        DEFAULT_COUNT = "0",
        WARNING_NONAME = "Debes ponerle un nombre a la categoría.", 
        WARNING_NODESC = "La categoría no tiene una descripción.",
    ...
    public void InitializeValues()
    {
        ...
        switch (Config.creatingCategory)
        {
            case true:
                ...
                warningsRunning = 0;
                promptcount_text.text = DEFAULT_COUNT;
                promptcount_text2.text = DEFAULT_COUNT;
                break;
            case false:
                isInitializing = true;
    ...
    public bool IsCategoryAllowed()
    {
        ...
        {
            StartCoroutine(ShowWarningText(WARNING_NONAME));
            return false;
        }
        ...
        {
            StartCoroutine(ShowWarningText(WARNING_NODESC));
            return false;
        }
        return true;
    }
